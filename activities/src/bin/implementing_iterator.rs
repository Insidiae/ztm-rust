...
fn main() {
	...
	println!("{:?}", multiplier.next().unwrap()); //? 1
	println!("{:?}", multiplier.next().unwrap()); //? 2
	println!("{:?}", multiplier.next().unwrap()); //? 3

	println!("+1 powerup obtained!");
	multiplier.per_iteration_bonus = 1; //? (+1 powerup obtained)

	println!("{:?}", multiplier.next().unwrap()); //? 5
	println!("{:?}", multiplier.next().unwrap()); //? 7
	println!("{:?}", multiplier.next().unwrap()); //? 9
}
